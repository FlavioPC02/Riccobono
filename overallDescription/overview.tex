...
BBP shall allow any user, either registered or not, to browse the map of the
metropolitan area and inspect the available bike paths. For each bike path,
the system shall display its location, length and the most recent publishable
status information contributed by the community.
